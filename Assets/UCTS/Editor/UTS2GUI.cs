...
namespace UnityChan
{
    ...
    // -----------------------------------------------------
        ...
        MaterialProperty _1st_HighColor_Step = null;
        MaterialProperty _2st_HighColor_Step = null;
        MaterialProperty _LightWidth = null;
        MaterialProperty _LightLength = null;
        MaterialProperty _1st2nd_Light_Feather = null;
        MaterialProperty _1st2nd_Light_Threshold = null;
        ...
        public void FindProperties(MaterialProperty[] props)
        {
            ...
            _LightMap = FindProperty("_LightMap",props);
            highColor = FindProperty("_HighColor", props);
            highColor_Power = FindProperty("_HighColor_Power", props);
            _1st_HighColor_Step = FindProperty("_1st_HighColor_Step", props);
            _2st_HighColor_Step = FindProperty("_2st_HighColor_Step", props);
            _LightWidth = FindProperty("_LightWidth", props);
            _LightLength = FindProperty("_LightLength", props);
            _1st2nd_Light_Feather = FindProperty("_1st2nd_Light_Feather", props);
            _1st2nd_Light_Threshold = FindProperty("_1st2nd_Light_Threshold", props);
    ...
    // --------------------------------
        ...
        private static class Styles
        {
            ...
            public static GUIContent highLightMapText = new GUIContent("HighLight Map","HighLight Map : Texture(linear)");
    ...
    // --------------------------------
        ...
        void GUI_HighColor(Material material)
        {
            ...
            if(!_SimpleUI){
                EditorGUILayout.BeginHorizontal();
                EditorGUILayout.PrefixLabel("Light Map");
                //GUILayout.Space(60);
                    if(material.GetFloat("_HightLightMap") == 0){
                        if (GUILayout.Button("Off",shortButtonStyle))
                        {
                            material.SetFloat("_HightLightMap",1);
                        }
                    }else{
                        if (GUILayout.Button("Active",shortButtonStyle))
                        {
                            material.SetFloat("_HightLightMap",0);
                        }
                    }
                EditorGUILayout.EndHorizontal();

                if(material.GetFloat("_HightLightMap") == 1)
                {
                    EditorGUI.indentLevel++;
                    GUILayout.Label("    Light Map Settings", EditorStyles.boldLabel);
                    m_MaterialEditor.TexturePropertySingleLine(Styles.highLightMapText, _LightMap);
                    m_MaterialEditor.ColorProperty(_1st_HighColor_Step, "1st HighColor Step");
                    m_MaterialEditor.ColorProperty(_2st_HighColor_Step, "2st HighColor Step");
                    m_MaterialEditor.RangeProperty(_LightWidth, "Light Width");
                    m_MaterialEditor.RangeProperty(_LightLength, "Light Length");
                    m_MaterialEditor.RangeProperty(_1st2nd_Light_Feather, "1st/2nd_Light_Feather");
                    m_MaterialEditor.RangeProperty(_1st2nd_Light_Threshold, "1st/2nd_Light_Threshold");
