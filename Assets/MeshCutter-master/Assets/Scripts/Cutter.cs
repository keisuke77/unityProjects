...
public bool forceon;
    ...
    {
        var obj = new GameObject("cut obj", typeof(MeshFilter), typeof(MeshRenderer),typeof(MeshCollider),typeof(CutMesh));
        ...
        if (forceon)
        {
             rigidBody.AddForce(Random.Range(-5, 5), Random.Range(0, 5), Random.Range(-5, 5), ForceMode.Impulse);
